//
// Created by jon on 1/7/2022.
//

#ifndef SDL2_ANDROID_EXAMPLE_HOSTVMSHARED_H
#define SDL2_ANDROID_EXAMPLE_HOSTVMSHARED_H
...
#endif //SDL2_ANDROID_EXAMPLE_HOSTVMSHARED_H
